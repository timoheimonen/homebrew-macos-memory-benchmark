...
class MemoryBenchmark < Formula
  ...
  url "https://github.com/timoheimonen/macOS-memory-benchmark/archive/refs/tags/v.0.45.tar.gz"
  sha256 "b2740eea51a832c6e27673750564380656a13bfa848f0f93f653b84b071af3e2"
  license "GPL-3.0"
