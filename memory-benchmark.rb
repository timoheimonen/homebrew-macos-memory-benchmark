...
class MemoryBenchmark < Formula
  ...
  url "https://github.com/timoheimonen/macOS-memory-benchmark/archive/refs/tags/v.0.55.0.tar.gz"
  sha256 "882ff2cd4cc5b6330ffb1e5c085887985fb1a1279b799f17127fa6785894d6a4"
  license "GPL-3.0"
